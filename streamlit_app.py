...
authenticator = stauth.Authenticate(st.secrets["credentials"]["names"], st.secrets["credentials"]["usernames"], hashed_passwords, st.secrets["auth"]["cookie_name"], st.secrets["auth"]["signature_key"], cookie_expiry_days=30)
